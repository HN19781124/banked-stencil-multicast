    ...
    checks = [
        ...
        run_check(
            ...
            [
                ...
                "discover",
                "-s",
                "applications/precision-clock/tests",
                "-v",
            ],
        ),
        run_check(
            ...
            [
                ...
                "discover",
                "-s",
                "applications/systolic-array/tests",
                "-v",
            ],
        ),
        run_check(
            "tdoa-sensor-reference",
            [
                sys.executable,
                "-B",
                "-m",
                ...
                "discover",
                "-s",
                "applications/tdoa-sensor/tests",
                "-v",
            ],
        ),
        run_check(
            ...
            [
                sys.executable,
                "-B",
                "applications/generate_performance_report.py",
                "--check",
            ],
        ),
        run_check(
